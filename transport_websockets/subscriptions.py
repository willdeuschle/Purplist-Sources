...
class SubscriptionManager(object):
    ...
    def subscribe(self, **kwargs):
        ...
        # think so because all of this is going to execute synchronously
        ...
        # an array of relevant subscriptions - I don't think we actually
        # need to track this bc the js version has it just for making sure
        # everything is resolved before proceeding
        # subscription_arr = []
        ...
        for trigger_name in trigger_map.keys():
            ...
            filter_func = trigger_map[trigger_name].get('filter', lambda *args: True)
